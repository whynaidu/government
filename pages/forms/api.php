...
{	 
	 ...
	 $sql = "INSERT INTO complaints (book_no,date,complaint_no,district,taluka,
	 police_station,sub_police_station,section,type_of_offence,complaint_filer_name,
	 complaint_filer_address,victim_name,criminal_name,
	 criminal_address,category_and_caste,caste_certificate,fir,aadhaar_card,bank_info,charge_sheet,
	 medical_report,medical_conformatio_31_report,discription)
	 VALUES ('$complaint_no')";
