          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">अर्जाचा नमुना</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="email" class="form-control " id="exampleemail" name="email" placeholder="">
					    ...
					    <div class="container d-flex "  style="margin-left: -12px;">
                 <div class="form-group col-6">
                    <label for="Examplepassword">पासवर्ड</label>
					...
					<div class="form-group col-6">
                    <label for="Example23">वापरकर्त्याचा भूमिका</label>
