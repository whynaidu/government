...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/charts/district.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>District</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/charts/taluka.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Taluka</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/charts/police.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Police Station</p>
                </a>
              </li>
  ...
  <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="R1.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>R1</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="R2.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                   <p>R2</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="R3.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                 <p>R3</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="R4.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                 <p>R4</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="R5.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                 <p>R5</p>
                </a>
              </li>
